...
## TL; DR
[Prompt-to-Prompt(P2P)](/docs/trustworthy-ai/diffusion-based/prompt-to-prompt.md)의 연구에서처럼, source에서 target image로 학습 없이 editing하려는 목적에서, cross-attention과 self-attention map의 replacement에 대한 효과를 구분해서 생각해야 할 필요가 있어보임.
...
![alt text](/img/figures/figure1.png)
...
![alt text](/img/figures/figure2.png)
...
![alt text](/img/figures/figure3.png)
...
![alt text](/img/figures/figure4.png)
...
![alt text](/img/figures/figure5.png)